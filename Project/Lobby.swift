...
class Lobby: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    var article:[(articleTitle:String, articlesubtitle:String)] = [("Survey Pet使用者滿意度跳查表", "本工作室為持續提供更好的服務，特製作本問卷，以瞭解您對本工作室服務品質、服務態度與業務電腦化的看法與建議，請您依實際經驗與個人認知，回答下列所有的問題，感謝您撥冗填寫，謝謝您！"), ("冷飲喜好調查", "徵求熱愛冷飲的朋友參與本次問卷調查！！"), ("未來就業期望調查", "希望了解學生對於未來就業的展望"), ("購物習慣調查", "請要了解各年齡層購物習慣")]
